...
function BlogComp({ date, title, views, likes, imageSrc }) {
  return (
    <div className="bg-white p-6 w-[20rem] rounded-xl shadow-lg transform hover:scale-105 transition duration-500">
      ...
      <button className="mt-4 text-lg w-fit text-white bg-indigo-600 py-2 px-5 rounded-xl shadow-xl">
        Read More
      </button>
    </div>
  );
