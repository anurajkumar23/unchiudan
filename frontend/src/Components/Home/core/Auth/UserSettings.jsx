      ...
      <div className="bg-white max-w-screen-xl mx-auto min-h-screen rounded-3xl overflow-hidden shadow-md flex flex-col sm:flex-row">
        <div className="bg-[#55c57a] sm:w-1/4 p-4">
          <ul className="side-nav">
            <li className="mb-4 text-white font-bold">Settings</li>
            <li className="mb-4 text-white font-bold">Study Material</li>
            <li className="mb-4 text-white font-bold">Billing</li>
            {user.role === "admin" ? (
              <li className="mb-4 text-white font-bold">Admin power</li>
            ) : (
              ""
            )}
          </ul>
        ...
        <div className="sm:w-3/4">
          <div className="user-view__form-container max-w-screen-xl mx-auto px-4 sm:px-8 md:px-16 lg:px-32">
            <h2 className="heading-secondary mt-8 mb-4 text-2xl text-[#55c57a]">
              Your account settings
            </h2>
            <form className="">
              <div className="mb-4">
                <label className="block">Name</label>
                <input className="form__input border border-gray-300 p-2 rounded" />
              </div>
          ...
          <hr className="my-8 " />
          <div className="user-view__form-container max-w-screen-xl mx-auto px-4 sm:px-8 md:px-16 lg:px-32">
            <h2 className="mt-8 mb-4 text-2xl">Password change</h2>
            <form className="">
              <div className=" mb-4">
